...
grep -Fq 'PUNCH_YELLOW_CHIP' "$layout" ||
  fail 'missing approved bright yellow chip chroma constant'
grep -Fq 'CockpitBenchChipId' "$layout" ||
  fail 'missing gray run_id chip highlight group'
